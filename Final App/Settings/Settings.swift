...
struct Settings {
    ...
    let apiDict = [
        ...
        "Test": URL(string: "https://i.rap.ph/R_Monogram_Circle_1000px-beCVHbk5.png"), // Static Image for testing
        "Unsplash": URL(string: "https://api.unsplash.com/photos/?client_id=")
    ]
